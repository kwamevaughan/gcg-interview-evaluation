  ...
  exportDOM(editor) {
    ...
    return {
      after: tableElement => {
        ...
        if (utils.isHTMLElement(tableElement) && tableElement.nodeName !== 'TABLE') {
      ...
      element: utils.isHTMLElement(element) && element.nodeName !== 'TABLE' ? element.querySelector('table') : element
    };
  }
  canBeEmpty() {
    return false;
...
function registerTablePlugin(editor) {
  ...
  }, lexical.COMMAND_PRIORITY_EDITOR), editor.registerNodeTransform(TableNode, $tableTransform), editor.registerNodeTransform(TableRowNode, $tableRowTransform), editor.registerNodeTransform(TableCellNode, $tableCellTransform));
}
