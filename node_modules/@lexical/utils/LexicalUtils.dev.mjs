...
function $dfsCaretIterator(direction, startNode, endNode) {
  ...
  const endCaret = $getAdjacentChildCaret(endNode ? $getChildCaretOrSelf($getSiblingCaret(endNode, direction)) : startCaret.getParentCaret(rootMode));
