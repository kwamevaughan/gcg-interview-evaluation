...
async function sendEmails({ fullName, email, phone, linkedin, opening, score, resumeUrl, coverLetterUrl, answers, candidateTemplate, adminTemplate, questions }) {
    ...
    const candidateHtml = candidateTemplate.replace("{{fullName}}", fullName).replace("{{score}}", `${score}/190 (${percentage}%)`);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__fbba3f._.js.map