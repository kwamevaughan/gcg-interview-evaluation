...
const supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im1vbm1mdHJvdG52eXVhcXR2dXdsIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDA1ODg1OTcsImV4cCI6MjA1NjE2NDU5N30.R_sz1NaM2tEigssP53FU-z07-xNHUB1cHqMvlDhY6i4");
...
async function handler(req, res) {
    ...
    try {
        ...
        const resume = fields.resume ? JSON.parse(fields.resume[0]) : null;
        const coverLetter = fields.coverLetter ? JSON.parse(fields.coverLetter[0]) : null;
        ...
        if (resume) {
            ...
            const { error: resumeError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$js__$5b$api$5d$__$28$ecmascript$29$__["supabase"].storage.from("resumes").upload(resumeFileName, Buffer.from(resume.data, "base64"), {
        ...
        if (coverLetter) {
            ...
            const { error: coverLetterError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$js__$5b$api$5d$__$28$ecmascript$29$__["supabase"].storage.from("cover-letters").upload(coverLetterFileName, Buffer.from(coverLetter.data, "base64"), {
        ...
        console.log("Attempting to insert into responses...");
...
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$pages$2f$api$2f$submit$2e$js__$5b$api$5d$__$28$ecmascript$29$__
]);
([__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$pages$2f$api$2f$submit$2e$js__$5b$api$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__);
;
;
;
;
