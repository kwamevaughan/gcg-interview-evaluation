    ...
    const handleOptionToggle = (questionIndex, option)=>{
        setFormData((prev)=>{
            ...
            if (currentAnswers.includes(option)) {
                ...
                updatedAnswers = questionIndex === 0 ? [
                    ...currentAnswers,
                    option
                ] : [
                    option
                ]; // Multi-select for Q1, single-select for others
            }
        ...
        (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$hot$2d$toast__$5b$external$5d$__$28$react$2d$hot$2d$toast$2c$__esm_import$29$__["default"])(`${option} ${formData.answers[questionIndex]?.includes(option) ? "deselected" : "selected"}`, {
            duration: 1000
        });
    };
...
function InterviewPage({ mode, toggleMode }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
        ...
        const fetchQuestions = async ()=>{
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["supabase"].from("interview_questions").select("*").order("id", {
                ascending: true
            });
            if (error) {
                console.error("Error fetching questions:", error);
                __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$hot$2d$toast__$5b$external$5d$__$28$react$2d$hot$2d$toast$2c$__esm_import$29$__["default"].error("Failed to load questions.");
            } else {
                setQuestions(data);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__d179ee._.js.map