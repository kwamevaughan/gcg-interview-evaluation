...
;
;
const Header = ({ mode, step, currentPage, totalPages, uploadProgress, answeredQuestions, totalQuestions, isStep1Complete })=>{
...
function Step2Questions({ formData, handleOptionToggle, currentPage, questionsPerPage, questions, handleNextPage, totalPages, onComplete }) {
    ...
    // Find the first unanswered question in sequence (excluding Q1 if not continued)
    ...
    // Auto-scroll to the current unanswered question or move to next page
    (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
        const allCurrentPageAnswered = currentQuestions.every((q)=>formData.answers[q.id - 1]?.length > 0);
        // If all questions on the current page are answered and we are not on the last page, go to the next page
        if (allCurrentPageAnswered && currentPage < totalPages - 1) {
            handleNextPage();
        } else if (isLastPage && allQuestionsAnswered) {
            // Stay on the last question when all questions are answered
            ...
            // Focus on the current unanswered question or the first question in the set
    ...
    // Handle "Continue" for Question 1
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
            ...
            children: currentQuestions.map((question, index)=>{
                ...
                // Determine current question focus logic
                let isCurrent = false;
                if (question.id === 1 && !hasContinuedFromQ1) {
                    isCurrent = true;
                } else if (hasContinuedFromQ1) {
                    if (currentQuestionIndex === -1) {
                        // If all are answered, keep the last question visible if it's the last one overall
                        if (isLastQuestion && isLastPage) {
                            isCurrent = true;
                        } else {
                            // Otherwise show the first of the current set
                            isCurrent = index === 0;
                        }
                    } else {
                ...
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
                    ...
                    className: `bg-white shadow-md rounded-lg p-4 transition-all duration-500 ${isAnswered && !isCurrent ? "opacity-50 blur-sm scale-95 -translate-y-10 pointer-events-none" : isCurrent ? "opacity-100 scale-100" : "opacity-50 blur-sm translate-y-10 pointer-events-none"}`,
                    children: [
                            ...
                            children: [
                                question.options.map((option, optIndex)=>{
                                    ...
                                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("button", {
                                        ...
                                        className: `w-full p-3 rounded-lg border-2 text-left text-sm font-semibold text-[#231812] transition-all duration-200 ${borderColors[optIndex % borderColors.length]} ${isSelected ? "bg-[#f05d23] border-[#f05d23] text-white" : "bg-white hover:bg-gray-100" + (isDisabled ? " cursor-not-allowed" : " cursor-pointer")}`,
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
                                ...
                                question.id === 1 && !hasContinuedFromQ1 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("button", {
                                        ...
                                        className: "px-4 py-2 bg-[#f05d23] text-white rounded hover:bg-[#d94f1e] disabled:bg-gray-300 disabled:text-gray-600 transition",
                                        children: "Continue"
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/Step2Questions.js",
                                        lineNumber: 161,
                        ...
                        isLastQuestion && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("button", {
                                ...
                                className: `px-6 py-3 bg-[#f05d23] text-white rounded hover:bg-[#d94f1e] transition ${!isLastQuestionAnswered ? "opacity-50 cursor-not-allowed" : ""}`,
                                children: "Upload CV"
                            }, void 0, false, {
                                fileName: "[project]/src/components/Step2Questions.js",
                                lineNumber: 175,
...
function DragDropZone({ type, file, isDragging, uploadProgress, isSubmitting, handleFileChange, handleDrop, handleDragOver, handleDragLeave, removeFile }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
        ...
        className: `p-6 flex justify-center bg-white border-2 border-dashed rounded-xl transition-all duration-300 ${isDragging ? "border-[#f05d23] bg-orange-50" : "border-gray-300"}`,
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("span", {
                                    ...
                                    children: file.name.endsWith(".pdf") ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("svg", {
                                        className: "w-5 h-5",
                                        xmlns: "http://www.w3.org/2000/svg",
                                        fill: "none",
                                        viewBox: "0 0 24 24",
...
;
;
function Step3Documents({ onComplete, totalPages, formData, isSubmitting, uploadProgress, setFormData, setUploadProgress, ...fileUploadProps }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
...
function InterviewPage() {
    ...
    const handleBack = ()=>{
        if (step === 2 && currentPage > 0) {
            ...
            setUploadProgress({
                resume: 0,
                coverLetter: 0
            }); // Reset progress when going back
    ...
    const handleQuestionsComplete = ()=>{
        ...
        setUploadProgress({
            resume: 0,
            coverLetter: 0
        }); // Reset upload progress for Step 3
        __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$hot$2d$toast__$5b$external$5d$__$28$react$2d$hot$2d$toast$2c$__esm_import$29$__["default"].success("All questions completed! Upload your documents next.");
    };
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__5de9e8._.js.map