...
function InterviewPage({ mode, toggleMode }) {
    ...
    const [questions, setQuestions] = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useState"])([]); // State for fetched questions
    ...
    (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
        ...
        const fetchQuestions = async ()=>{
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["supabase"].from("interview_questions").select("*").order("id", {
                ascending: true
            });
            if (error) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__d46af0._.js.map