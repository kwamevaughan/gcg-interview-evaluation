...
async function handler(req, res) {
    ...
    try {
        ...
        if (resume) {
            ...
            const resumeExt = resume.startsWith("JVBERi0") ? "pdf" : "docx"; // Basic PDF check (starts with %PDF- in base64)
            ...
            const { error: resumeError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$js__$5b$api$5d$__$28$ecmascript$29$__["supabase"].storage.from("resumes").upload(resumeFileName, resumeBuffer, {
                contentType: resumeExt === "pdf" ? "application/pdf" : "application/vnd.openxmlformats-officedocument.wordprocessingml.document"
            });
            if (resumeError) {
        ...
        if (coverLetter) {
            ...
            const { error: coverLetterError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$js__$5b$api$5d$__$28$ecmascript$29$__["supabase"].storage.from("cover-letters").upload(coverLetterFileName, coverLetterBuffer, {
                contentType: coverLetterExt === "pdf" ? "application/pdf" : "application/vnd.openxmlformats-officedocument.wordprocessingml.document"
            });
            if (coverLetterError) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__9d34fc._.js.map