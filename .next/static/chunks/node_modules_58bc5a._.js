(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/node_modules_58bc5a._.js", {
...
"[project]/node_modules/@editorjs/header/dist/header.umd.js [client] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/@editorjs/list/dist/editorjs-list.umd.js [client] (ecmascript)": (function(__turbopack_context__) {
...
(function(P, _) {
    ...
    Object.defineProperty(Z, "__esModule", {
        value: !0
    }), Z.calculateBaseline = St;
    function St(e) {
        var t = window.getComputedStyle(e), n = parseFloat(t.fontSize), r = parseFloat(t.lineHeight) || n * 1.2, i = parseFloat(t.paddingTop), a = parseFloat(t.borderTopWidth), l = parseFloat(t.marginTop), s = n * .8, o = (r - n) / 2, d = l + a + i + o + s;
        return d;
    }
    (function(e) {
        Object.defineProperty(e, "__esModule", {
    ...
    })(ee), Object.defineProperty(x, "__esModule", {
        value: !0
    }), x.canSetCaret = Et;
    var kt = O, _t = ee;
    function Et(e) {
    ...
    function ie(e, ...t) {
        ...
        const n = t.shift();
        if (A(e) && A(n)) for(const r in n)A(n[r]) ? (e[r] === void 0 && Object.assign(e, {
            [r]: {}
        }), ie(e[r], n[r])) : Object.assign(e, {
            [r]: n[r]
        });
        return ie(e, ...t);
    }
    ...
    Object.defineProperty(ne, "__esModule", {
        value: !0
    }), ne.containsOnlyInlineElements = Vt;
    var Xt = ae, Gt = J;
    function Vt(e) {
        var t;
    ...
    var ue = {}, ce = {}, Ke = M && M.__spreadArray || function(e, t, n) {
    ...
    Object.defineProperty(ce, "__esModule", {
        value: !0
    }), ce.getDeepestBlockElements = Xe;
    var en = N;
    function Xe(e) {
        return (0, en.containsOnlyInlineElements)(e) ? [
            e
        ] : Array.from(e.children).reduce(function(t, n) {
            return Ke(Ke([], t, !0), Xe(n), !0);
        }, []);
    }
    (function(e) {
        Object.defineProperty(e, "__esModule", {
    ...
    })(W), Object.defineProperty(de, "__esModule", {
        value: !0
    }), de.getDeepestNode = Ve;
    var rn = O, an = B, ln = W;
    function Ve(e, t) {
        t === void 0 && (t = !1);
        ...
        if (e.nodeType === Node.ELEMENT_NODE && e[n]) {
            var i = e[n];
            if ((0, ln.isSingleTag)(i) && !(0, rn.isNativeInput)(i) && !(0, an.isLineBreakTag)(i)) if (i[r]) i = i[r];
    ...
    function dn(e) {
        return Array.from(e.querySelectorAll((0, un.allInputsSelector)())).reduce(function(t, n) {
            return (0, cn.isNativeInput)(n) || (0, sn.containsOnlyInlineElements)(n) ? D(D([], t, !0), [
                n
            ], !1) : D(D([], t, !0), (0, on.getDeepestBlockElements)(n), !0);
        }, []);
    }
    (function(e) {
        Object.defineProperty(e, "__esModule", {
    ...
    })(Se), Object.defineProperty(be, "__esModule", {
        value: !0
    }), be.isEmpty = kn;
    var Sn = ye, On = Se;
    function kn(e, t) {
    ...
    Object.defineProperty(H, "__esModule", {
        value: !0
    }), H.checkContenteditableSliceForEmptiness = An;
    var Mn = c, Nn = F;
    function An(e, t, n, r) {
        ...
        if (t === void 0 && (t = !0), (0, $n.isNativeInput)(e)) {
            ...
            if (o(u)) {
                ...
                if (o(u) && u.nodeType === Node.TEXT_NODE) {
                    var h = (r = (n = u.textContent) === null || n === void 0 ? void 0 : n.length) !== null && r !== void 0 ? r : 0, i = t ? 0 : h;
    ...
    function Wn() {
        ...
        return t === null ? [
            null,
            0
        ] : (t.nodeType !== Node.TEXT_NODE && t.childNodes.length > 0 && (t.childNodes[n] !== void 0 ? (t = t.childNodes[n], n = 0) : (t = t.childNodes[n - 1], t.textContent !== null && (n = t.textContent.length))), [
            t,
            n
        ]);
    }
    ...
    var Kn = c, Xn = q;
    function Gn() {
        var e = (0, Xn.getRange)(), t = (0, Kn.make)("span");
    ...
    class $e {
        ...
        merge(t) {
            const n = this.block.holder.querySelectorAll(`.${p.item}`), r = n[n.length - 1], i = z(r);
    ...
    class K {
        ...
        static joinRecursive(t) {
            return t.items.map((n)=>`${n.content} ${K.joinRecursive(n)}`).join("");
        }
        render() {
        ...
        renderSettings() {
            ...
            if (this.listStyle === "ordered") {
                const n = Jn((a)=>this.changeStartWith(Number(a)), {
                    ...
                    icon: ut.get(this.data.meta.counterType),
                    children: {
                        items: []
                    }
                };
...
"[project]/node_modules/@editorjs/paragraph/dist/paragraph.umd.js [client] (ecmascript)": (function(__turbopack_context__) {
...
(function(i, n) {
    ("TURBOPACK compile-time value", "object") == "object" && ("TURBOPACK compile-time value", "object") < "u" ? module.exports = n() : typeof define == "function" && define.amd ? ((r)=>r !== undefined && __turbopack_export_value__(r))(n(__turbopack_require__, exports, module)) : (i = typeof globalThis < "u" ? globalThis : i || self, i.Paragraph = n());
})(this, function() {
    "use strict";
    const i = "", n = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M8 9V7.2C8 7.08954 8.08954 7 8.2 7L12 7M16 9V7.2C16 7.08954 15.9105 7 15.8 7L12 7M12 7L12 17M12 17H10M12 17H14"/></svg>';
    function s(a) {
...
//# sourceMappingURL=node_modules_58bc5a._.js.map