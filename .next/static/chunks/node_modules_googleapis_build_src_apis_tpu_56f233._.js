(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/node_modules_googleapis_build_src_apis_tpu_56f233._.js", {

"[project]/node_modules/googleapis/build/src/apis/tpu/v1.js [client] (ecmascript)": (function(__turbopack_context__) {
...
})(tpu_v1 || (exports.tpu_v1 = tpu_v1 = {}));
}}),
"[project]/node_modules/googleapis/build/src/apis/tpu/v1alpha1.js [client] (ecmascript)": (function(__turbopack_context__) {
...
})(tpu_v1alpha1 || (exports.tpu_v1alpha1 = tpu_v1alpha1 = {}));
}}),
"[project]/node_modules/googleapis/build/src/apis/tpu/v2.js [client] (ecmascript)": (function(__turbopack_context__) {
...
(function(tpu_v2) {
    ...
    tpu_v2.Resource$Projects = Resource$Projects;
    class Resource$Projects$Locations {
        constructor(context){
            this.context = context;
            this.acceleratorTypes = new Resource$Projects$Locations$Acceleratortypes(this.context);
        ...
        generateServiceIdentity(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v2/{+parent}:generateServiceIdentity').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: ''
                }, options),
                params,
    ...
    tpu_v2.Resource$Projects$Locations = Resource$Projects$Locations;
    class Resource$Projects$Locations$Acceleratortypes {
        constructor(context){
            this.context = context;
        }
        ...
        list(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v2/{+parent}/acceleratorTypes').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'GET',
                    apiVersion: ''
                }, options),
                params,
    ...
    tpu_v2.Resource$Projects$Locations$Acceleratortypes = Resource$Projects$Locations$Acceleratortypes;
    class Resource$Projects$Locations$Nodes {
        constructor(context){
            this.context = context;
        }
        create(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v2/{+parent}/nodes').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: ''
                }, options),
                params,
        ...
        getGuestAttributes(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v2/{+name}:getGuestAttributes').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: ''
                }, options),
                params,
    ...
    tpu_v2.Resource$Projects$Locations$Nodes = Resource$Projects$Locations$Nodes;
    class Resource$Projects$Locations$Operations {
        constructor(context){
            this.context = context;
        }
    ...
    class Resource$Projects$Locations$Runtimeversions {
        ...
        list(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v2/{+parent}/runtimeVersions').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'GET',
                    apiVersion: ''
                }, options),
                params,
    ...
    tpu_v2.Resource$Projects$Locations$Runtimeversions = Resource$Projects$Locations$Runtimeversions;
})(tpu_v2 || (exports.tpu_v2 = tpu_v2 = {}));
}}),
"[project]/node_modules/googleapis/build/src/apis/tpu/v2alpha1.js [client] (ecmascript)": (function(__turbopack_context__) {
...
(function(tpu_v2alpha1) {
    ...
    class Resource$Projects$Locations$Queuedresources {
        ...
        create(paramsOrCallback, optionsOrCallback, callback) {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v2alpha1/{+parent}/queuedResources').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'POST',
                    apiVersion: ''
                }, options),
                params,
...
})(tpu_v2alpha1 || (exports.tpu_v2alpha1 = tpu_v2alpha1 = {}));
}}),
"[project]/node_modules/googleapis/build/src/apis/tpu/index.js [client] (ecmascript)": (function(__turbopack_context__) {
...
const v1_1 = __turbopack_require__("[project]/node_modules/googleapis/build/src/apis/tpu/v1.js [client] (ecmascript)");
...
const v1alpha1_1 = __turbopack_require__("[project]/node_modules/googleapis/build/src/apis/tpu/v1alpha1.js [client] (ecmascript)");
Object.defineProperty(exports, "tpu_v1alpha1", {
    enumerable: true,
    get: function() {
        return v1alpha1_1.tpu_v1alpha1;
    }
});
const v2_1 = __turbopack_require__("[project]/node_modules/googleapis/build/src/apis/tpu/v2.js [client] (ecmascript)");
...
const v2alpha1_1 = __turbopack_require__("[project]/node_modules/googleapis/build/src/apis/tpu/v2alpha1.js [client] (ecmascript)");
Object.defineProperty(exports, "tpu_v2alpha1", {
    enumerable: true,
    get: function() {
        return v2alpha1_1.tpu_v2alpha1;
    }
});
exports.VERSIONS = {
    v1: v1_1.tpu_v1.Tpu,
...
function tpu(versionOrOptions) {
    return (0, googleapis_common_1.getAPI)('tpu', versionOrOptions, exports.VERSIONS, this);
}
exports.tpu = tpu;
...
//# sourceMappingURL=node_modules_googleapis_build_src_apis_tpu_56f233._.js.map