(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/[root of the server]__7c7120._.js", {
...
const useQuestions = ()=>{
    ...
    const fetchQuestions = async ()=>{
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$js__$5b$client$5d$__$28$ecmascript$29$__["supabase"].from("interview_questions").select("*").order(sortField, {
    ...
    const addQuestion = async (text, options, points)=>{
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$js__$5b$client$5d$__$28$ecmascript$29$__["supabase"].from("interview_questions").insert([
            {
                text,
    ...
    const editQuestion = async (id, text, options, points)=>{
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$js__$5b$client$5d$__$28$ecmascript$29$__["supabase"].from("interview_questions").update({
            text,
            options: optionsArray,
            points: pointsObject,
    ...
    const deleteQuestion = async (id, text)=>{
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$js__$5b$client$5d$__$28$ecmascript$29$__["supabase"].from("interview_questions").delete().eq("id", id);
        if (error) {
    ...
    const moveQuestion = async (fromIndex, toIndex)=>{
        ...
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$js__$5b$client$5d$__$28$ecmascript$29$__["supabase"].from("interview_questions").upsert(updates);
        if (error) {
...
_s(HRInterviewQuestions, "XW0GMA6GcHlt/aArBu1gj6RhFQ4=", false, function() {
    return [
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__7c7120._.js.map