(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/node_modules_prosemirror-view_dist_index_bca8cb.js", {

"[project]/node_modules/prosemirror-view/dist/index.js [client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
class MarkViewDesc extends ViewDesc {
    ...
    static create(parent, mark, inline, view) {
        ...
        if (!spec || !spec.dom) spec = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["DOMSerializer"].renderSpec(document, mark.type.spec.toDOM(mark, inline), null, mark.attrs);
...
class NodeViewDesc extends ViewDesc {
    ...
    static create(parent, node, outerDeco, innerDeco, view, pos) {
        ...
        if (node.isText) {
            ...
            let spec = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["DOMSerializer"].renderSpec(document, node.type.spec.toDOM(node), null, node.attrs);
            ({ dom, contentDOM } = spec);
        }
    ...
    parseRule() {
        ...
        if (!this.contentDOM) {
            ...
            if (!rule.contentElement) rule.getContent = ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Fragment"].empty;
        }
        return rule;
    }
    matchesNode(node, outerDeco, innerDeco) {
    ...
    updateChildren(view, pos) {
        ...
        iterDeco(this.node, this.innerDeco, (widget, i, insideNode)=>{
            ...
            else if (widget.type.side >= 0 && !insideNode) updater.syncToMarks(i == this.node.childCount ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Mark"].none : this.node.child(i).marks, inline, view);
    ...
    localCompositionInfo(view, pos) {
        ...
        if (!(view.state.selection instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["TextSelection"]) || from < pos || to > pos + this.node.content.size) return null;
...
function selectionFromDOM(view, origin = null) {
    ...
    if (selectionCollapsed(domSel)) {
        ...
        if (nearestDesc && nearestDescNode.isAtom && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["NodeSelection"].isSelectable(nearestDescNode) && nearestDesc.parent && !(nearestDescNode.isInline && isOnEdge(domSel.focusNode, domSel.focusOffset, nearestDesc.dom))) {
            let pos = nearestDesc.posBefore;
            selection = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["NodeSelection"](head == pos ? $head : doc.resolve(pos));
        }
    } else {
...
function selectionToDOM(view, force = false) {
    ...
    if (view.cursorWrapper) {
        ...
        if (brokenSelectBetweenUneditable && !(sel instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["TextSelection"])) {
...
function selectionBetween(view, $anchor, $head, bias) {
    return view.someProp("createSelectionBetween", (f)=>f(view, $anchor, $head)) || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["TextSelection"].between($anchor, $head, bias);
}
...
function moveSelectionBlock(state, dir) {
    ...
    return $start && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Selection"].findFrom($start, dir);
}
...
function selectHorizontally(view, dir, mods) {
    ...
    if (sel instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["TextSelection"]) {
        if (mods.indexOf("s") > -1) {
            ...
            return apply(view, new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["TextSelection"](sel.$anchor, $newHead));
        } else if (!sel.empty) {
            return false;
        } else if (view.endOfTextblock(dir > 0 ? "forward" : "backward")) {
            let next = moveSelectionBlock(view.state, dir);
            if (next && next instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["NodeSelection"]) return apply(view, next);
            return false;
            ...
            if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["NodeSelection"].isSelectable(node)) {
                return apply(view, new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["NodeSelection"](dir < 0 ? view.state.doc.resolve($head.pos - node.nodeSize) : $head));
            } else if (webkit) {
                // Chrome and Safari will introduce extra pointless cursor
                // positions around inline uneditable nodes, so we have to
                // take over and move the cursor past them (#937)
                return apply(view, new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["TextSelection"](view.state.doc.resolve(dir < 0 ? nodePos : nodePos + node.nodeSize)));
            } else {
                return false;
            }
        }
    } else if (sel instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["NodeSelection"] && sel.node.isInline) {
        return apply(view, new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["TextSelection"](dir > 0 ? sel.$to : sel.$from));
    } else {
        let next = moveSelectionBlock(view.state, dir);
...
function selectVertically(view, dir, mods) {
    let sel = view.state.selection;
    if (sel instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["TextSelection"] && !sel.empty || mods.indexOf("s") > -1) return false;
    ...
    if (!$from.parent.inlineContent) {
        ...
        let beyond = sel instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["AllSelection"] ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Selection"].near(side, dir) : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Selection"].findFrom(side, dir);
        return beyond ? apply(view, beyond) : false;
    }
    return false;
}
function stopNativeHorizontalDelete(view, dir) {
    if (!(view.state.selection instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["TextSelection"])) return true;
...
function serializeForClipboard(view, slice) {
    ...
    let serializer = view.someProp("clipboardSerializer") || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["DOMSerializer"].fromSchema(view.state.schema);
...
function parseFromClipboard(view, text, html, plainText, $context) {
    ...
    if (asText) {
        ...
        if (inCode) return text ? new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Slice"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Fragment"].from(view.state.schema.text(text.replace(/\r\n?/g, "\n"))), 0, 0) : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Slice"].empty;
        let parsed = view.someProp("clipboardTextParser", (f)=>f(text, $context, plainText, view));
        if (parsed) {
            slice = parsed;
        } else {
            let marks = $context.marks();
            let { schema } = view.state, serializer = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["DOMSerializer"].fromSchema(schema);
    ...
    if (!slice) {
        let parser = view.someProp("clipboardParser") || view.someProp("domParser") || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["DOMParser"].fromSchema(view.state.schema);
    ...
    if (sliceData) {
        ...
        slice = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Slice"].maxOpen(normalizeSiblings(slice.content, $context), true);
...
function normalizeSiblings(fragment, $context) {
    ...
    for(let d = $context.depth; d >= 0; d--){
        ...
        if (result) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Fragment"].from(result);
    }
    return fragment;
}
function withWrappers(node, wrap, from = 0) {
    for(let i = wrap.length - 1; i >= from; i--)node = wrap[i].create(null, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Fragment"].from(node));
    return node;
}
...
function addToSibling(wrap, lastWrap, node, sibling, depth) {
    if (depth < wrap.length && depth < lastWrap.length && wrap[depth] == lastWrap[depth]) {
        ...
        if (match.matchType(depth == wrap.length - 1 ? node.type : wrap[depth + 1])) return sibling.copy(sibling.content.append(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Fragment"].from(withWrappers(node, wrap, depth + 1))));
    }
}
function closeRight(node, depth) {
    if (depth == 0) return node;
    let fragment = node.content.replaceChild(node.childCount - 1, closeRight(node.lastChild, depth - 1));
    let fill = node.contentMatchAt(node.childCount).fillBefore(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Fragment"].empty, true);
...
function closeRange(fragment, side, from, to, depth, openEnd) {
    ...
    if (depth >= from) inner = side < 0 ? node.contentMatchAt(0).fillBefore(inner, openEnd <= depth).append(inner) : inner.append(node.contentMatchAt(node.childCount).fillBefore(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Fragment"].empty, true));
    return fragment.replaceChild(side < 0 ? 0 : fragment.childCount - 1, node.copy(inner));
}
function closeSlice(slice, openStart, openEnd) {
    if (openStart < slice.openStart) slice = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Slice"](closeRange(slice.content, -1, openStart, slice.openStart, 0, slice.openEnd), openStart, slice.openEnd);
    if (openEnd < slice.openEnd) slice = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Slice"](closeRange(slice.content, 1, openEnd, slice.openEnd, 0, 0), slice.openStart, openEnd);
    return slice;
}
...
function addContext(slice, context) {
    ...
    for(let i = array.length - 2; i >= 0; i -= 2){
        ...
        content = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Fragment"].from(type.create(array[i + 1], content));
        openStart++;
        openEnd++;
    }
    return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Slice"](content, openStart, openEnd);
}
...
editHandlers.keypress = (view, _event)=>{
    ...
    let sel = view.state.selection;
    if (!(sel instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["TextSelection"]) || !sel.$from.sameParent(sel.$to)) {
...
function selectClickedLeaf(view, inside) {
    ...
    if (node && node.isAtom && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["NodeSelection"].isSelectable(node)) {
        updateSelection(view, new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["NodeSelection"]($pos), "pointer");
        return true;
    }
    return false;
}
function selectClickedNode(view, inside) {
    ...
    if (sel instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["NodeSelection"]) selectedNode = sel.node;
    let $pos = view.state.doc.resolve(inside);
    for(let i = $pos.depth + 1; i > 0; i--){
    ...
    if (selectAt != null) {
        updateSelection(view, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["NodeSelection"].create(view.state.doc, selectAt), "pointer");
        return true;
    } else {
        return false;
    }
...
function defaultTripleClick(view, inside, event) {
    ...
    if (inside == -1) {
        if (doc.inlineContent) {
            updateSelection(view, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["TextSelection"].create(doc, 0, doc.content.size), "pointer");
            return true;
        }
        return false;
    }
    ...
    for(let i = $pos.depth + 1; i > 0; i--){
        ...
        if (node.inlineContent) updateSelection(view, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["TextSelection"].create(doc, nodePos + 1, nodePos + 1 + node.content.size), "pointer");
        else if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["NodeSelection"].isSelectable(node)) updateSelection(view, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["NodeSelection"].create(doc, nodePos), "pointer");
        else continue;
        return true;
    }
}
...
class MouseDown {
    ...
    up(event) {
        ...
        if (this.allowDefault || !pos) {
            ...
            updateSelection(this.view, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Selection"].near(this.view.state.doc.resolve(pos.pos)), "pointer");
            event.preventDefault();
        } else {
            setSelectionOrigin(this.view, "pointer");
        }
...
editHandlers.compositionstart = editHandlers.compositionupdate = (view)=>{
    if (!view.composing) {
        ...
        if (state.selection instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["TextSelection"] && (state.storedMarks || !$pos.textOffset && $pos.parentOffset && $pos.nodeBefore.marks.some((m)=>m.type.spec.inclusive === false))) {
...
function doPaste(view, text, html, preferPlain, event) {
    ...
    if (view.someProp("handlePaste", (f)=>f(view, event, slice || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Slice"].empty))) return true;
...
handlers.dragstart = (view, _event)=>{
    ...
    let node;
    if (pos && pos.pos >= sel.from && pos.pos <= (sel instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["NodeSelection"] ? sel.to - 1 : sel.to)) ;
    else if (mouseDown && mouseDown.mightDrag) {
        node = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["NodeSelection"].create(view.state.doc, mouseDown.mightDrag.pos);
    } else if (event.target && event.target.nodeType == 1) {
        let desc = view.docView.nearestDesc(event.target, true);
        if (desc && desc.node.type.spec.draggable && desc != view.docView) node = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["NodeSelection"].create(view.state.doc, desc.posBefore);
    }
...
editHandlers.drop = (view, _event)=>{
    ...
    if (view.someProp("handleDrop", (f)=>f(view, event, slice || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Slice"].empty, move))) {
        event.preventDefault();
        return;
    }
    if (!slice) return;
    event.preventDefault();
    let insertPos = slice ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$transform$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["dropPoint"])(view.state.doc, $mouse.pos, slice) : $mouse.pos;
    ...
    if (isNode && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["NodeSelection"].isSelectable(slice.content.firstChild) && $pos.nodeAfter && $pos.nodeAfter.sameMarkup(slice.content.firstChild)) {
        tr.setSelection(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["NodeSelection"]($pos));
    } else {
...
function parseBetween(view, from_, to_) {
    ...
    let parser = view.someProp("domParser") || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["DOMParser"].fromSchema(view.state.schema);
...
function readDOMChange(view, from, to, typeOver, addedNodes) {
    ...
    if (!change) {
        if (typeOver && sel instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["TextSelection"] && !sel.empty && sel.$head.sameParent(sel.$anchor) && !view.composing && !(parse.sel && parse.sel.anchor != parse.sel.head)) {
            change = {
                start: sel.from,
                endA: sel.to,
                endB: sel.to
    ...
    if (view.state.selection.from < view.state.selection.to && change.start == change.endB && view.state.selection instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["TextSelection"]) {
...
function isMarkChange(cur, prev) {
    ...
    if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$model$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Fragment"].from(updated).eq(cur)) return {
        mark,
        type
    };
}
...
*/ class EditorView {
    ...
    */ scrollToSelection() {
        ...
        else if (this.state.selection instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["NodeSelection"]) {
    ...
    updateDraggedNode(dragging, prev) {
        ...
        this.dragging = new Dragging(dragging.slice, dragging.move, found < 0 ? undefined : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prosemirror$2d$state$2f$dist$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["NodeSelection"].create(this.state.doc, found));
    }
    someProp(propName, f) {
...
//# sourceMappingURL=node_modules_prosemirror-view_dist_index_bca8cb.js.map