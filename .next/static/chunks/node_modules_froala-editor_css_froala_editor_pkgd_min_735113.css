/* [project]/node_modules/froala-editor/css/froala_editor.pkgd.min.css [client] (css) */
.fr-clearfix:after {
  clear: both;
  display: block;
  content: "";
...
.fr-modal .fr-modal-wrapper {
  ...
  background: #fff;
  min-width: 300px;
  -webkit-box-shadow: 0 3px 5px -1px #0003, 0 6px 10px #00000024, 0 1px 18px #0000001f;
  -moz-box-shadow: 0 3px 5px -1px #0003, 0 6px 10px #00000024, 0 1px 18px #0000001f;
...
@media screen and (-ms-high-contrast: active) and (width <= 768px), (-ms-high-contrast: none) and (width <= 768px) {
  .fr-popup .fr-icon-container {
    width: 236px;
  }
}
...
@media screen and (width >= 400px) and (width <= 469px) {
  .fr-upload-section {
    margin-left: 7px;
    margin-right: 7px;
  }
...
@media screen and (width >= 470px) and (width <= 680px) {
  .fr-upload-section {
    margin-left: 7px;
    margin-right: 7px;
  }
...
.dot {
  width: 20px;
  height: 20px;
  background-image: radial-gradient(circle, gray 1px, #0000 2px);
...
.fr-view .fr-table-selection-hover {
  outline: 2px solid #fdcf00;
}

.fr-view .fr-table-selected {
  outline: 2px solid #0d65ff;
  caret-color: #0000;
}
...
/*# sourceMappingURL=node_modules_froala-editor_css_froala_editor_pkgd_min_735113.css.map*/