(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/[root of the server]__65022e._.js", {
...
const useFormData = ()=>{
    ...
    const handleOptionToggle = (questionIndex, option)=>{
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["default"])(`${option} ${formData.answers[questionIndex]?.includes(option) ? "deselected" : "selected"}`, {
            duration: 1000
        });
    };
...
_s(useFormData, "J8IVhRSZB1JpaN7PK9mS+6M8qUk=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_refresh__.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "InterviewPage.useEffect": ()=>{
            ...
            const fetchQuestions = {
                "InterviewPage.useEffect.fetchQuestions": async ()=>{
                    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$js__$5b$client$5d$__$28$ecmascript$29$__["supabase"].from("interview_questions").select("*").order("id", {
                        ascending: true
                    });
                    if (error) {
                        console.error("Error fetching questions:", error);
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["default"].error("Failed to load questions.");
                    } else {
                        setQuestions(data);
                        // Initialize answers array with empty sub-arrays for each question
                        setFormData({
                            "InterviewPage.useEffect.fetchQuestions": (prev)=>({
                                    ...prev,
                                    answers: Array(data.length).fill([])
                                })
                        }["InterviewPage.useEffect.fetchQuestions"]);
                    }
                }
            }["InterviewPage.useEffect.fetchQuestions"];
            fetchQuestions();
...
_s(InterviewPage, "0klQ+YsBGDNQDbVpDTjXro1ijGM=", false, function() {
    return [
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__65022e._.js.map