(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/[root of the server]__7bd675._.js", {
...
function InterviewPage({ mode, toggleMode }) {
    ...
    const [questions, setQuestions] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])([]); // State for fetched questions
        ...
        "InterviewPage.useEffect": ()=>{
            ...
            const fetchQuestions = {
                "InterviewPage.useEffect.fetchQuestions": async ()=>{
                    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$js__$5b$client$5d$__$28$ecmascript$29$__["supabase"].from("interview_questions").select("*").order("id", {
                        ascending: true
                    });
                    if (error) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__7bd675._.js.map