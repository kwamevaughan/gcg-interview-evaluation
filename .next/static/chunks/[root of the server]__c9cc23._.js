(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/[root of the server]__c9cc23._.js", {
...
const supabaseUrl = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_SUPABASE_PROJECT_URL;
const supabaseAnonKey = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_SUPABASE_ANON_KEY;
...
const supabaseServiceKey = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].env.SUPABASE_SERVICE_KEY;
if (!supabaseServiceKey) {
    console.error("Missing Supabase Service Key in environment variables.");
}
const supabaseAdmin = supabaseServiceKey ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$supabase$2d$js$2f$dist$2f$module$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createClient"])(supabaseUrl, supabaseServiceKey) : null;
...
const UserProvider = ({ children })=>{
    ...
    const [userFullName, setUserFullName] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])('Guest');
        ...
        "UserProvider.useEffect": ()=>{
            ...
            if (storedSession) {
                try {
                    ...
                    if (session.user?.id) {
                        const fetchUserData = {
                            "UserProvider.useEffect.fetchUserData": async ()=>{
                                const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$js__$5b$client$5d$__$28$ecmascript$29$__["supabase"].from('client_users').select('name').eq('id', session.user.id).single();
                                if (error) {
                        ...
                        }["UserProvider.useEffect.fetchUserData"];
                        fetchUserData();
                    }
                } catch (error) {
...
_s1(UserProvider, "hX/1T+yWF/quwJpy9pK8eV03FPs=");
_c = UserProvider;
var _c;
...
"[project]/src/components/SessionExpired.js [client] (ecmascript)": (function(__turbopack_context__) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$SessionExpired$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/components/SessionExpired.js [client] (ecmascript)");
...
function MyApp({ Component, pageProps }) {
    ...
    const [isSessionExpired, setIsSessionExpired] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MyApp.useEffect": ()=>{
            ...
            const handleChange = {
                "MyApp.useEffect.handleChange": (e)=>{
                    if (savedMode === 'system') {
                        setMode(e.matches ? 'dark' : 'light');
                    }
                }
            }["MyApp.useEffect.handleChange"];
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$UserContext$2e$js__$5b$client$5d$__$28$ecmascript$29$__["UserProvider"], {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(UserComponent, {
                mode: mode,
...
_s(MyApp, "jHDFCICsN8Fz2d8+N5GIsCVPTIQ=", false, function() {
    return [
...
const UserComponent = ({ mode, isSessionExpired, setIsSessionExpired, router, Component, pageProps })=>{
    _s1();
    const { user, token, setToken, setUser } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$UserContext$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useUser"])(); // Destructure setUser here
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "UserComponent.useEffect": ()=>{
    ...
    if (isSessionExpired && router.pathname !== '/participate') {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$SessionExpired$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"], {
            isSessionExpired: isSessionExpired
        }, void 0, false, {
            fileName: "[project]/src/pages/_app.js",
            lineNumber: 85,
...
_s1(UserComponent, "YAFxSq1FfL64z2Ni83uxbqm2AV4=", false, function() {
    return [
...
__turbopack_refresh__.register(_c1, "UserComponent");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_refresh__.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__c9cc23._.js.map