(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/[root of the server]__078e28._.js", {
...
function HRJobBoard({ mode = "light", toggleMode }) {
    ...
    const handleEditSubmit = async (e)=>{
        ...
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$js__$5b$client$5d$__$28$ecmascript$29$__["supabase"].from("job_openings").update(updatedJobData).eq("id", editJob.id);
        if (error) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__078e28._.js.map