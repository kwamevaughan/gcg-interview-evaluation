...
export const sidebarNav = [
    ...
    { href: "/hr/email-templates", icon: "lsicon:email-send-outline", label: "Email Templates" },
    { href: "/hr/automations", icon: "carbon:power-virtual-server-disaster-recovery-automation", label: "Automations" },
];