...
export default function EmailModal({ candidate, isOpen, onClose, emailData, setEmailData, onSend, mode }) {
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-60 flex justify-center items-center z-50">
            <div className={`${mode === "dark" ? "bg-gray-800 text-white" : "bg-white"} rounded-xl max-w-3xl w-full mx-4 shadow-2xl transform transition-all duration-300 animate-fade-in flex flex-col max-h-[90vh]`}>
